...
class PartialThree extends StatefulWidget {
  const PartialThree({super.key});

  @override
  State<PartialThree> createState() => _PartialThreeState();
}

class _PartialThreeState extends State<PartialThree> {
  @override
